...
define i32 @main() nounwind uwtable {
  ...
  store %struct.CPUX86State* bitcast ([7058 x i64]* @tcg_env to %struct.CPUX86State*), %struct.CPUX86State** @env, align 8
  store i64 ptrtoint ([7058 x i64]* @tcg_env to i64), i64* %tcg_env_add, align 8
