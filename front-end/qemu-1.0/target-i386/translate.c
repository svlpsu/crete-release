...
#endif //#if defined(CRETE_DBG_INST_BASED_CALL_STACK)
...
static target_ulong disas_insn(DisasContext *s, target_ulong pc_start, CPUState* env)
{
                                                  ...
                                                  int search_pc)
{
    ...
    for(;;) {
        ...
        pc_ptr = disas_insn(dc, pc_ptr, env);
        num_insns++;
