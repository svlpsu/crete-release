...
#if defined(CRETE_DBG_TLB_FILL) && !defined(S2E_LLVM_LIB)
#include "runtime-dump/runtime-dump.h"
extern CPUState *g_cpuState_bct;
#endif

#if defined(CRETE_DEP_ANALYSIS)
...
void helper_crete_make_symbolic(void)
{
    ...
    assert(flag_rt_dump_enable && "Must be capture-enable at this point, so long as dependency analysis remains a subset of other code selection");
#endif // defined(CRETE_DEP_ANALYSIS)
...
#if defined(CRETE_DBG_CALL_STACK) && !defined(S2E_LLVM_LIB)
...
static void QEMU_NORETURN raise_interrupt(int intno, int is_int, int error_code,
                                          int next_eip_addend)
{
#if defined(CRETE_DBG_REPLAY_INTERRUPT) && !defined(S2E_LLVM_LIB)
	if(flag_rt_dump_enable) {
        if(crete_post_runtime_dump(g_cpuState_bct, rt_dump_tb)) {
            flag_dump_interrupt_CPUState = 1;
            add_qemu_interrupt_state(runtime_env, intno, is_int, error_code, next_eip_addend);
        }
	}
#endif //#if defined(CRETE_DBG_REPLAY_INTERRUPT) && !defined(S2E_LLVM_LIB)
...
{
#if defined(CRETE_DBG_TLB_FILL) && !defined(S2E_LLVM_LIB) && defined(CRETE_DBG_CALL_STACK)
        if(flag_rt_dump_enable) {
...
#if defined(CRETE_DBG_CURRENT) && !defined(S2E_LLVM_LIB)
...
#else // #if defined(CRETE_DBG_REPLAY_INTERRUPT)
        	flag_rt_dump_enable = 0;
#endif

        }
#endif //#if defined(CRETE_DBG_TLB_FILL) && !defined(S2E_LLVM_LIB)
