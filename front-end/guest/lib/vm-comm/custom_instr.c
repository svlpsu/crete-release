...
void __crete_make_symbolic(void) // No inlining. Needs to be separate function to list in dump list.
{
    __asm__ __volatile__(
...
void __crete_make_symbolic_internal(void)
{
...
/*
 * Obsolete convention:
 * Information format convention is:
 * "Dump MO Start. Symbolic/Concrete.\n"
 * "name size, guest_address;"
 */
