...
//	if(index == TCG_REG_ESP)
//		printf("esp = %u\n", (uint32_t)tci_reg[index]);
#endif
...
{
#ifdef DBG_BO_PAST
	printf("In tci.c, tcg_qemu_tb_exec has been invoked!\n");
#endif
    ...
    for (;;) {
        ...
        case INDEX_op_brcond_i32:
            ...
            if (tci_compare32(t0, t1, condition)) {
                ...
                if(crete_flag_capture_enabled &&
                   flag_rt_dump_enable &&
                   is_target_pid)
                {
                    crete_brcond_stack_push(1);
                }
        ...
        case INDEX_op_bswap64_i64:
            ...
            printf("INDEX_op_bswap64_i64: TODO() skipped\n");
