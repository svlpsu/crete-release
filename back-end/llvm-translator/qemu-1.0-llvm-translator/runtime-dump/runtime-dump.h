...
extern uint64_t g_havlicek_target_pid;
...
#endif //#if defined(DBG_BO_REPLAY_INTERRUPT)
...
private:
    ...
    std::map<uint64_t, std::pair<bool, bool> > m_tbExecSequBranchResults; // <pc, branch left or right was taken>
#endif // defined(HAVLICEK_TB_GRAPH)
...
#if defined(DBG_BO_CALL_STACK)
    void updateCallStack(uint64_t tb_pc);
